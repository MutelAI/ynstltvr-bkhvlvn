/**
 * Static UI labels — mirrors i18n-defaults.ts from the Angular template.
 * 'he' = primary/Hebrew, 'en' = English.
 */
export const I18N_DEFAULTS: Record<string, { he: string; en: string }> = {
  ...
  hero_badge:               { he: 'מקצועי ומהיר',                      en: 'Professional & Fast' },
  hero_subtitle:            { he: 'שירות מקצועי, מהיר ואמין',          en: 'Professional, fast and reliable service' },
  hero_cta_call:            { he: 'התקשר עכשיו',                        en: 'Call Now' },
  hero_cta_whatsapp:        { he: 'ווטסאפ',                             en: 'WhatsApp' },
  hero_available:           { he: 'זמין לשיחות ופגישות',               en: 'Available for calls and meetings' },
  stars_out_of:             { he: 'מתוך 5',                             en: 'out of 5' },
  reviews_happy:            { he: 'ביקורות מרוצות',                     en: 'happy reviews' },
  about_title:              { he: 'עלינו',                              en: 'About Us' },
  about_desc:               { he: 'אנחנו מספקים שירות מקצועי ואמין ללקוחותינו', en: 'We provide professional and reliable service to our customers' },
  ...
  services_subtitle:        { he: 'פתרונות מקצועיים לכל צורך',         en: 'Professional solutions for every need' },
  gallery_title:            { he: 'גלריית עבודות',                      en: 'Work Gallery' },
  gallery_subtitle:         { he: 'דוגמאות מהעבודות שלנו',             en: 'Examples from our work' },
  ...
  contact_subtitle:         { he: 'נשמח לשמוע ממך ולעזור בכל שאלה',    en: "We'd love to hear from you and help with any question" },
  ...
  hero_cycle_1:              { he: 'מקצועי',                              en: 'Professional' },
  hero_cycle_2:              { he: 'מהיר',                                en: 'Fast' },
  hero_cycle_3:              { he: 'אמין',                                en: 'Reliable' },
  hero_cycle_4:              { he: 'מומחה',                               en: 'Expert' },
  about_tag_rating:          { he: 'דירוג',                               en: 'Rating' },
  about_tag_reviews:         { he: 'ביקורות',                             en: 'Reviews' },
  about_tag_experience:      { he: 'ניסיון',                              en: 'Experience' },
  about_tag_availability:    { he: 'זמינות',                              en: 'Availability' },
  about_status_active:       { he: 'פעיל',                                en: 'Active' },
};
